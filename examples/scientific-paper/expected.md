...
We estimate the response from noisy observations. The objective combines fit and regularization:
$J(\theta)=\sum_i(y_i-f_\theta(x_i))^2+\lambda\lVert\theta\rVert^2$.
